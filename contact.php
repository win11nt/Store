...
<div class="container" id="content">
    <div style="margin-bottom: 42px;" class="row">
    <div class="col-lg">
        <img src="img/contact-us.png" style="float: right; width: 22%;">
        <h1>Get in Touch</h1>
    ...
    <div class="col-lg" style="white-space: nowrap; display: flex;">
        ...
        <form>
            <div class="form-group">
                <input style="border: 1px solid #000;"type="text" name="name" placeholder="Name" autofocus="on" class="form-control" required = "true" pattern="^[A-Za-z\s]{1,}[\.]{0,1}[A-Za-z\s]{0,}$">
            </div>
            <div class="form-group">
                <input style="border: 1px solid #000;" type="email" name="email" placeholder="Email" class="form-control"
